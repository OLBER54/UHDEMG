...
HD_PWD='C:/Users/olivi/Documents/Universite Laval/Maitrise/DataStreamTest/DataStreamTest.runs/multiplier_18x18_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_18x18.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplier_18x18.tcl
