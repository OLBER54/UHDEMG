...
{
    // Create RHX Controller with 2 kHz per-amplifier sampling rate.
    RHXController *rhxController = new RHXController(ControllerRecordUSB3, SampleRate2000Hz);
    ...
    */
    ...
    cout << "Devices found: " << availableDevices.size() << endl;

    if (availableDevices.empty()) {
        cout << "No Opal Kelly device found." << endl;
        return -1;
    }
    ...
    cout << "Uploading bitfile..." << endl;
    rhxController->uploadFPGABitfile("ConfigRHDController_7310.bit");

    cout << "Initializing..." << endl;
    rhxController->initialize();

    cout << "Enabling stream..." << endl;
    rhxController->enableDataStream(0, true);
