...
while MUnum<Total_num
    ...
    title({
    'Press "enter": accept current firing train.';
    'Input "0": discard the current spike train and look for the next one.';
    'Input "66": use valley-finding clustering.';
    'Input "88": discard the current result and end the program.';
